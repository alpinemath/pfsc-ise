...
var Hub = declare(null, {
    ...
    aboutPbeUrl: 'https://alpinemath.org/download/pbe.html',
    bugReportUrl: 'https://github.com/alpinemath/pfsc-ise/issues',
    ocaUpgradeUrl: 'https://alpinemath.org/pise/running_the_ise/basic.html#upgrading',
    ...
    */
     ...
     * mode), or that the user appears to own the libpath.
     *
    ...
    userHasAccess: function(libpath) {
        return this.personalServerMode || this.userOwns(libpath);
    },
